...
class MyApp extends StatelessWidget {
  ...
  static const String _title = 'IoT Traffic Light System';
  ...
  Future<MqttServerClient?> connect() async {
    ...
    client.updates?.listen((List<MqttReceivedMessage<MqttMessage>> c) {
      ...
      setState(() {
        ...
        mqttMsg = msg.split(':');
        final cmd = int.parse(mqttMsg[0]);
        print(c[0].topic.toString());
        if (txtTopicCtrl.text == c[0].topic.toString()) {
          switch (cmd) {
            case 1:
              eventGR();
              break;
                ...
                child: TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderSide:
                          BorderSide(color: Colors.amberAccent, width: 3.0),
                    ),
